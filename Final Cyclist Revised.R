...
#Cyclistic Member vs Casual Rider User Pattern
##Muhammad Ahmed - Mahmedkpk
###2nd of October 2024

###This project was undertaken as part of the Google Professional Certification,
###Introduction to Data Analytics. Let's dive in!
...
###I am assigned a task my the marketing department director(Lily Moreno)
###How do annual members and casual riders use Cyclistic bikes differently?
...
##Daily Ride Breakdown ---------

###Count the number of rides per day of the week for each user type
...
###Define pastel colors for user types
color_palette <- c("member" = "#CE5757", "casual" = "#99CCFF")  # Pastel red and blue

###Plot the number of rides per day of the week for each user type
...
##Most used Station by month and user type ------


####This code chunk was formed by CHATGPT. File size was above 1GB
####Due to which access to tableau and SQL was not possible
...
ggplot(most_used_start_stations %>% filter(member_casual == "casual"), 
  ...
  geom_bar(stat = "identity", width = 1, color = "black") +  # Adding black outline
...
##Percentage of total rides per month by top 5 stations------
